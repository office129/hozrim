...
export function ClientShell({
  ...
  return (
    <div className="min-h-app-svh flex flex-col md:flex-row bg-cream-2" dir="rtl">
      ...
      <div className="flex-1 flex justify-center md:justify-start">
        <div className="w-full sm:max-w-[412px] md:max-w-none sm:min-h-[844px] md:min-h-screen h-app-svh bg-cream sm:rounded-[28px] md:rounded-none shadow-[0_30px_60px_-20px_oklch(0.2_0.03_150_/_0.35),0_0_0_1px_oklch(0.9_0.02_150)] md:shadow-none overflow-hidden flex flex-col relative sm:my-8 md:my-0 mx-auto md:mx-0">
